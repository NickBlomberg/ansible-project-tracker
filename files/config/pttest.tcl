...
set server                    "pttest"
set servername                "Project Tracker"

set serverroot                "/data/web/${server}"
...
ns_param   serverlog          /var/log/aolserver/${server}-error.log
ns_param   pidfile	      /var/log/aolserver/nspid.pttest
...
# We use a separate file for MIME types,
# so servers can share it.
source /etc/aolserver/mime-types.tcl
...
ns_param   file               /var/log/aolserver/${server}.log
